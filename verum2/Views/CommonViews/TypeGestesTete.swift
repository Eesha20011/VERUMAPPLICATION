        ...
        ZStack {
            ...
            Image(AxeLatéralGauche(choice: 4))
                ...
                Image(AxeRotatifDroit(choice: 4))
                    ...
                    .frame(width: 200, height: 50, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                    .cornerRadius(60)
                        NavigationLink(destination: Gesture(nom: AxeRotatifDroit(choice: 1), explication: AxeRotatifDroit(choice: 2), exemple: AxeRotatifDroit(choice: 3), images: AxeRotatifDroit(choice: 4), image1: AxeRotatifDroit(choice: 5), image2: AxeRotatifDroit(choice: 6), image3: AxeRotatifDroit(choice: 7), image4: AxeRotatifDroit(choice: 8), image5: AxeRotatifDroit(choice: 9))){
                        HStack {
                        Text("En savoir plus")
                        .font(.custom("Ruluko-Regular", size: 17))
                        .foregroundColor(.white)
                ...
                Image(MainsAuFront(choice: 4))
                    ...
                    .frame(width: 200, height: 50, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                    .cornerRadius(60)
                        NavigationLink(destination: Gesture(nom: MainsAuFront(choice: 1), explication: MainsAuFront(choice: 2), exemple: MainsAuFront(choice: 3), images: MainsAuFront(choice: 4), image1: MainsAuFront(choice: 5), image2: MainsAuFront(choice: 6), image3: MainsAuFront(choice: 7), image4: MainsAuFront(choice: 8), image5: MainsAuFront(choice: 9))){
                        HStack {
                        Text("En savoir plus")
                        .font(.custom("Ruluko-Regular", size: 17))
                        .foregroundColor(.white)
                ...
                Image(BloquerLesOreilles(choice: 4))
                    ...
                    .frame(width: 200, height: 50, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                    .cornerRadius(60)
                        NavigationLink(destination: Gesture(nom: BloquerLesOreilles(choice: 1), explication: BloquerLesOreilles(choice: 2), exemple: BloquerLesOreilles(choice: 3), images: BloquerLesOreilles(choice: 4), image1: BloquerLesOreilles(choice: 5), image2: BloquerLesOreilles(choice: 6), image3: BloquerLesOreilles(choice: 7), image4: BloquerLesOreilles(choice: 8), image5: BloquerLesOreilles(choice: 9))){
                        HStack {
                        Text("En savoir plus")
                        .font(.custom("Ruluko-Regular", size: 17))
                        .foregroundColor(.white)
